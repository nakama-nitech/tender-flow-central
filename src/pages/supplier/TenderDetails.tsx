...
import { ArrowLeft, Calendar, DollarSign, FileText, Users, Tag, Clock, Download, Send, MessageSquare } from 'lucide-react';
import { format } from 'date-fns';
import { Tender, TenderCategory, TenderDocument, TenderQuestion } from '@/types/tender';
import { useToast } from '@/hooks/use-toast';

// Mock data for tenders with documents and questions
const mockTenderDetails: Record<string, Tender> = {
  ...
  '3': {
    ...
    description: 'Professional services for annual financial audit and compliance review. This engagement includes a comprehensive audit of financial statements, internal controls assessment, and regulatory compliance review. The audit must follow generally accepted auditing standards and applicable industry regulations.',
    category: 'services',
    budget: 45000,
...
const SupplierTenderDetails: React.FC = () => {
  ...
  const handleSubmitQuestion = () => {
    ...
    setTimeout(() => {
      toast({
        ...
        description: "Your question has been submitted and is awaiting response",
      });
      setNewQuestion('');
            ...
            <CardContent className="space-y-4">
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4 mt-4">
                ...
                <div className="space-y-1">
                  ...
                  <p className="text-sm pl-6">{tender.documents?.length || 0} documents available</p>
                </div>
              </div>
            </CardContent>
            ...
            <CardContent>
              <div className="space-y-4">
                ...
                <div className="flex items-start gap-4">
                  ...
                  <div>
                    <p className="text-sm font-medium">Questions Deadline</p>
                    <p className="text-xs text-muted-foreground">
                      {formatDate(new Date(new Date(tender.deadline).getTime() - 7 * 24 * 60 * 60 * 1000).toISOString())}
                    </p>
                  </div>
                </div>
        ...
        <TabsContent value="documents" className="space-y-4">
          <Card>
            <CardHeader>
              ...
              <CardDescription>Download the required documents for bid preparation</CardDescription>
            </CardHeader>
            <CardContent>
              <div className="space-y-4">
            ...
            <CardContent>
              <div className="space-y-6">
                {tender.questions && tender.questions.length > 0 ? (
                  ...
                  <p className="text-sm text-muted-foreground mb-4">No questions have been asked about this tender yet.</p>
                )}
...
export default SupplierTenderDetails;
